...
def test_postgres_writer_skips_negative_delta_and_records_anomaly() -> None:
    executed: dict[str, object] = {"queries": []}
    ...
    writer.persist(datetime(2026, 3, 16, 10, 20, 30, tzinfo=timezone.utc), 995)
